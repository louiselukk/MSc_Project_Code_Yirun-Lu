...
if __name__ == "__main__":
    ...
    plot_timeavg_acf_subplots_compare('alpha',      alpha_values,  base_params, num_steps, max_lag, seed_base,         save_dir)
    plot_timeavg_acf_subplots_compare('beta',       beta_values,   base_params, num_steps, max_lag, seed_base + 100,   save_dir)
    plot_timeavg_acf_subplots_compare('noise_std',  noise_values,  base_params, num_steps, max_lag, seed_base + 200,   save_dir)
    plot_timeavg_acf_subplots_compare('spread',     spread_values, base_params, num_steps, max_lag, seed_base + 300,   save_dir)
    plot_timeavg_acf_subplots_compare('window_size',window_values, base_params, num_steps, max_lag, seed_base + 400,   save_dir)
